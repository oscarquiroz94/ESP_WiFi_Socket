...
// 				JsonDocument outdoc;
// 				outdoc["id"] = doc["id"];
// 				outdoc["data"]["aire"] = vaOP.temp_ET;
// 				outdoc["data"]["grano"] = vaOP.temp_BT;
// 				outdoc["data"]["ror"] = vaOP.RoR;
// 				outdoc["data"]["quemador"] = vaOP.porcent_Quem;
// 				outdoc["data"]["soplador"] = vaOP.porcent_Sopl;
// 				outdoc["data"]["tambor"] = vaOP.porcent_Tamb;
// 				outdoc["data"]["delta"] = vaOP.deltaETBT;
...
// 				vaCO.tedvalue = (int16_t)doc["params"]["tedvalue"];
// 				Serial.print("PARAM,");Serial.print(vaCO.aire);Serial.print(',');
// 				Serial.print(vaCO.tambor);Serial.print(',');
// 				Serial.print(vaCO.quemador);Serial.print(',');
...
// 				vaCO.aire = (uint16_t)doc["params"]["aire"];
// 			// if(doc["params"].containsKey("soplador")) vaCO.aire = (uint16_t)doc["params"]["soplador"];
// 			if (doc["params"].containsKey("tambor"))
// 				vaCO.tambor = (uint16_t)doc["params"]["tambor"];
// 			if (doc["params"].containsKey("quemador"))
// 				vaCO.quemador = (uint16_t)doc["params"]["quemador"];
// 			if (doc["params"].containsKey("tedvalue"))
// 				vaCO.tedvalue = (uint16_t)doc["params"]["tedvalue"];

// 			Serial.print("PARAM,");
// 			Serial.print(vaCO.aire);
// 			Serial.print(',');
// 			Serial.print(vaCO.tambor);
// 			Serial.print(',');
// 			Serial.print(vaCO.quemador);
// 			Serial.print(',');
